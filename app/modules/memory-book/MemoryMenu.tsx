...
export default function MemoryMenu({ navigation }: Props) {
  ...
  return (
    <Layout>
      <TopNav
        ...
        // 🔽 custom right section: theme toggle + "add other" (friend search)
        rightContent={
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("UserSearch")}>
              <Ionicons
                name="person-add-outline" // Instagram-style add/search user
                size={22}
                color={isDarkmode ? themeColor.white100 : themeColor.dark}
              />
            </TouchableOpacity>
          ...
          {latestMemory ? (
            ...
            <View style={{ marginTop: 8 }}>
              ...
              <Button
                ...
                onPress={() => navigation.navigate("MemoryPostCreate")}
                leftContent={
